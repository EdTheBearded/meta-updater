...
SRC_URI = " \
  ...
  file://run-ptest \
  ${@ d.expand("https://github.com/uptane/ota-tuf/releases/download/v${GARAGE_SIGN_PV}/cli-${GARAGE_SIGN_PV}.tgz;unpack=0;name=garagesign") if not oe.types.boolean(d.getVar('GARAGE_SIGN_AUTOVERSION')) else ''} \
  "
